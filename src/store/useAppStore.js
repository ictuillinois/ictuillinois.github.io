...
export const useAppStore = create((set, get) => ({
  ...
  clearSession: () => {
    ...
    set({ session: null, loginMode: null, activeModules: null, labUserAllowedPool: null, currentProjectId: null, sidebarSubTab: null, screen: 'dashboard' })
  },
  ...
  // Per-labUser module pool (labUserLocked modules, e.g. QR Labels, granted individually
  ...
  labUserAllowedPool: null,
  setLabUserAllowedPool: (pool) => set({ labUserAllowedPool: pool }),
